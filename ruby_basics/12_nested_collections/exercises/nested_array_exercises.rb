...
def delete_seat_from_row(chart, row_index, seat_index)
  # take a chart and delete the seat at seat_index of the row at row_index of the chart, then return the chart
...
def count_empty_seats(chart)
  ...
  flattened_chart = chart.flatten
  flattened_chart.count(nil)
end

def find_favorite(array_of_hash_objects)
  # take an array_of_hash_objects and return the hash which has the key/value pair :is_my_favorite? => true. If no hash returns the value true to the key :is_my_favorite? it should return nil
  ...
  # TIP: there will only be a maximum of one hash in the array that will return true to the :is_my_favorite? key
